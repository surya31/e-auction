...
class AuctionEvent(BaseModel):
    ...
    start_time = models.DateTimeField(help_text=u'Format (Hour & Minute are optional): 03/25/20016 14:30')
    end_time = models.DateTimeField(help_text=u'Format (Hour & Minute are optional): 03/25/2016 14:30')
